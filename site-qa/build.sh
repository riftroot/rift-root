...
for f in tweaks-panel.jsx components/header.jsx components/footer.jsx components/sections.jsx components/about-contact.jsx components/erebus-page.jsx components/surface-page.jsx components/router.jsx app.jsx; do
  base="$(basename "$f" .jsx)"
  out="$TMP/${base}.js"
...
{
  for base in tweaks-panel header footer sections about-contact erebus-page surface-page router app; do
    printf '(function(){'
    cat "$TMP/${base}.js"
    printf '\n})();\n'
  done
